...
function replaceEqualDeep$1(a, b, depth = 0) {
  ...
  for (let i = 0; i < bSize; i++) {
    ...
    if (aItem === bItem) {
      copy[key] = aItem;
      if (array ? i < aSize : hasOwn$2.call(a, key)) equalItems++;
      continue;
    }
...
function replaceEqualDeep(prev, _next, _makeObj = () => ({}), _depth = 0) {
  ...
  for (let i = 0; i < nextSize; i++) {
    ...
    const v2 = replaceEqualDeep(p, n, _makeObj, _depth + 1);
    copy[key] = v2;
    if (v2 === p) equalItems++;
  }
...
function parseSegments(defaultCaseSensitive, data, route, start, node, depth, onRoute) {
  ...
  let cursor = start;
  {
    ...
    const isLeaf2 = (route.path || !route.children) && !route.isRoot;
    if (isLeaf2 && path.endsWith("/")) {
...
const loadRouteMatch = async (inner, matchPromises, index) => {
  async function handleLoader(preload2, prevMatch, previousRouteMatchId, match2, route2) {
    ...
    if (preload2 && route2.options.preload === false) ;
  ...
  if (shouldSkipLoader(inner, matchId)) {
    ...
    if (prevMatch._nonReactive.loaderPromise) {
      ...
      await handleLoader(preload2, prevMatch, previousRouteMatchId, match2, route);
    }
  }
  const match = inner.router.getMatch(matchId);
...
function applySearchMiddleware({
  ...
  return middleware(search2, dest, _includeValidateSearch ?? false);
}
...
function SkipLink(t0) {
  const $ = compilerRuntimeExports.c(3);
  const {
    targetId: t1,
    children: t2
  } = t0;
  const targetId = t1 === void 0 ? "main-content" : t1;
  const children = t2 === void 0 ? "Skip to main content" : t2;
  const t3 = `#${targetId}`;
  let t4;
  if ($[0] !== children || $[1] !== t3) {
    t4 = /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: t3, className: "skip-link", children });
    $[0] = children;
    $[1] = t3;
    $[2] = t4;
  } else {
...
function NavRail(t0) {
  ...
  const currentPath = t1 === void 0 ? "/" : t1;
  let t2;
  if ($[0] !== currentPath || $[1] !== onNavigate) {
    t2 = navItems.map((item) => {
      const isActive = currentPath === item.path;
      const Icon2 = item.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `#${item.path}`, "aria-current": isActive ? "page" : void 0, onClick: (e) => {
        e.preventDefault();
...
function Header(t0) {
  ...
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-semibold text-fg", children: "Zorivest" });
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  let t2;
  if ($[1] !== onCommandPaletteToggle) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 py-2 border-b border-bg-elevated", children: [
      t1,
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onCommandPaletteToggle, className: "text-xs text-fg-muted px-1.5 py-0.5 border border-bg-elevated rounded hover:bg-bg-elevated hover:text-fg transition-colors cursor-pointer", "aria-label": "Open command palette", children: "Ctrl+K" }) })
    ] });
    $[1] = onCommandPaletteToggle;
    $[2] = t2;
  } else {
    t2 = $[2];
  }
...
function StatusFooter() {
  ...
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "flex items-center px-4 py-1 text-xs text-fg-muted border-t border-bg-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ready" }) });
    $[0] = t0;
  } else {
    t0 = $[0];
  }
...
function createStaticEntries(navigate) {
  return [
    ...
    },
    {
      ...
      icon: Upload,
      action: () => {
        console.info("[command] Import Trades — not yet implemented");
      }
    },
    {
      id: "action:review",
      ...
      icon: ClipboardCheck,
      action: () => {
        console.info("[command] Account Review — not yet implemented");
      }
    },
...
function CommandPalette({
  ...
  const executeEntry = reactExports.useCallback((entry_0) => {
    entry_0.action();
    onClose();
  }, [onClose]);
  const selectedIndexRef = reactExports.useRef(selectedIndex);
  selectedIndexRef.current = selectedIndex;
  const flatResultsRef = reactExports.useRef(flatResults);
  ...
  const handleKeyDown = reactExports.useCallback((e) => {
    switch (e.key) {
      ...
      case "ArrowDown":
        e.preventDefault();
        setSelectedIndex((i_0) => Math.min(i_0 + 1, flatResultsRef.current.length - 1));
        break;
      case "ArrowUp":
        e.preventDefault();
      ...
      case "Enter": {
        ...
        const entry_1 = flatResultsRef.current[idx];
        if (idx >= 0 && entry_1) {
          executeEntry(entry_1);
        }
        break;
      }
    }
  ...
  if (!open) return null;
  let flatIndex = -1;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "dialog", "aria-label": "Command Palette", className: "fixed inset-0 z-50 flex items-start justify-center pt-[20vh]", onClick: onClose, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/50" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[520px] max-h-[60vh] bg-bg-elevated border border-bg-subtle rounded-lg shadow-2xl overflow-hidden flex flex-col", onClick: (e_0) => e_0.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-b border-bg-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: inputRef, type: "search", role: "searchbox", placeholder: "Type a command…", value: query, onChange: (e_1) => {
        setQuery(e_1.target.value);
        setSelectedIndex(-1);
      }, onKeyDown: handleKeyDown, className: "w-full bg-transparent text-fg text-sm outline-none placeholder:text-fg-muted" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: listRef, role: "listbox", className: "overflow-y-auto p-1", children: [
        Array.from(grouped.entries()).map(([category, entries_0]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1.5 text-xs font-semibold text-fg-muted uppercase tracking-wider", children: categoryLabels[category] ?? category }),
          entries_0.map((entry_2) => {
            flatIndex++;
            const idx_0 = flatIndex;
            const isSelected = idx_0 === selectedIndex;
            const Icon2 = entry_2.icon;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "option", "aria-selected": isSelected, "data-index": idx_0, onClick: () => executeEntry(entry_2), className: `flex items-center gap-3 px-3 py-2 rounded-md cursor-pointer text-sm transition-colors
                      ${isSelected ? "bg-accent-cyan/20 text-fg" : "text-fg-muted hover:bg-bg-subtle/50 hover:text-fg"}`, children: [
              Icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, "aria-hidden": "true" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: entry_2.label }),
              entry_2.shortcut && /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "text-xs text-fg-muted px-1 py-0.5 border border-bg-subtle rounded", children: entry_2.shortcut })
            ] }, entry_2.id);
          })
        ] }, category)),
        flatResults.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-sm text-fg-muted text-center", children: "No commands found" })
      ] })
    ] })
  ] });
}
function AppShell(t0) {
  ...
  let t11;
  if ($[13] !== t10 || $[14] !== t8) {
    t11 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-bg text-fg", children: [
      t3,
      t4,
      t8,
      t10
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
});
const accountsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/",
  component: React.lazy(() => __vitePreload(() => import("./AccountsHome-DT2blo9l.js"), true ? [] : void 0, import.meta.url))
});
const tradesRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/trades",
  component: React.lazy(() => __vitePreload(() => import("./TradesLayout-DdOIEgp7.js"), true ? [] : void 0, import.meta.url))
});
const planningRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/planning",
  component: React.lazy(() => __vitePreload(() => import("./PlanningLayout-DlXAK3rm.js"), true ? [] : void 0, import.meta.url))
});
const schedulingRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/scheduling",
  component: React.lazy(() => __vitePreload(() => import("./SchedulingLayout-DdUDDBv7.js"), true ? [] : void 0, import.meta.url))
});
const settingsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/settings",
  component: React.lazy(() => __vitePreload(() => import("./SettingsLayout-C1cCCG4W.js"), true ? [] : void 0, import.meta.url))
});
...
function NotificationProvider(t0) {
  ...
  const suppressedRef = reactExports.useRef(t1);
  let t2;
  if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = (t32) => {
      ...
      const toastFn = category === "error" ? ue.error : ue.info;
      toastFn(message, {
        description,
        duration: category === "error" ? Infinity : duration ?? 4e3
      });
    };
    $[1] = t2;
  } else {
  ...
  if ($[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsxRuntimeExports.jsx($e, { position: "bottom-right", toastOptions: {
  ...
  let t5;
  if ($[4] !== children) {
    t5 = /* @__PURE__ */ jsxRuntimeExports.jsxs(NotificationContext.Provider, { value: t3, children: [
      children,
      t4
    ] });
    $[4] = children;
...
function ModuleSkeleton() {
  ...
  let t0;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "status", "aria-label": "Loading module", className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-pulse text-fg-muted text-sm", children: "Loading…" }) });
    $[0] = t0;
  } else {
    t0 = $[0];
  }
...
function App() {
  ...
  let t1;
  if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(ModuleSkeleton, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) }) });
    $[1] = t1;
  } else {
    t1 = $[1];
  }
...
if (rootEl) {
  clientExports.createRoot(rootEl).render(/* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }));
}
export {
