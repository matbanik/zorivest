...
function orderColumns(leafColumns, grouping, groupedColumnMode) {
  ...
  const nonGroupingColumns = leafColumns.filter((col2) => !grouping.includes(col2.id));
  if (groupedColumnMode === "remove") {
    return nonGroupingColumns;
  }
  const groupingColumns = grouping.map((g) => leafColumns.find((col2) => col2.id === g)).filter(Boolean);
...
const tradeColumns = [col.accessor("created_at", {
  ...
  cell: (info) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: val === "BOT" ? "text-green-400" : "text-red-400", children: val });
  }
  ...
  cell: (info) => {
    const val = info.getValue();
    if (val === null) return "";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: val >= 0 ? "text-green-400" : "text-red-400", children: [
      val >= 0 ? "+" : "",
      val.toFixed(0)
    ] });
  },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-testid": "trade-list", className: "flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-t border-bg-subtle text-sm text-fg-muted", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => table.nextPage(), disabled: !table.getCanNextPage(), className: "px-2 py-1 rounded bg-bg-elevated disabled:opacity-30", children: "Next" })
      ] })
    ] })
  ] });
}
...
function ScreenshotPanel(t0) {
  ...
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-fg", children: "Screenshots" });
    $[6] = t5;
  } else {
    t5 = $[6];
  }
  ...
  if ($[7] !== screenshots) {
    ...
    if ($[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t72 = (ss) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setLightboxUrl(ss.url), className: "w-20 h-20 rounded-md overflow-hidden border border-bg-subtle hover:border-accent transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: ss.url, alt: ss.caption, className: "w-full h-full object-cover" }) }, ss.id);
      $[9] = t72;
    } else {
      t72 = $[9];
    }
    t6 = screenshots.map(t72);
    $[7] = screenshots;
    $[8] = t6;
  } else {
    t6 = $[8];
  ...
  if ($[10] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t7 = /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => fileInputRef.current?.click(), "data-testid": "screenshot-upload-btn", className: "w-20 h-20 rounded-md border border-dashed border-bg-subtle hover:border-accent text-fg-muted hover:text-fg flex items-center justify-center text-2xl transition-colors", children: "+" });
    $[10] = t7;
  } else {
    t7 = $[10];
  }
  let t8;
  if ($[11] !== t6) {
    t8 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
      t6,
      t7
    ] });
    $[11] = t6;
  ...
  let t9;
  if ($[13] !== handleFileChange) {
    t9 = /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: fileInputRef, type: "file", accept: "image/*", onChange: handleFileChange, className: "hidden", "data-testid": "screenshot-file-input" });
    $[13] = handleFileChange;
    $[14] = t9;
  } else {
    t9 = $[14];
  ...
  if ($[15] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-fg-muted", children: "Drag files, click +, or press Ctrl+V to paste from clipboard" });
    $[15] = t10;
  } else {
    t10 = $[15];
  }
  let t11;
  if ($[16] !== lightboxUrl) {
    t11 = lightboxUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 flex items-center justify-center z-50", onClick: () => setLightboxUrl(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: lightboxUrl, alt: "Screenshot preview", className: "max-w-[90vw] max-h-[90vh] rounded-lg" }) });
    $[16] = lightboxUrl;
    $[17] = t11;
  } else {
    t11 = $[17];
  ...
  let t12;
  if ($[18] !== handlePaste || $[19] !== t11 || $[20] !== t8 || $[21] !== t9) {
    t12 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onPaste: handlePaste, className: "space-y-3", children: [
      t5,
      t8,
      t9,
      t10,
...
function StarRating(t0) {
  ...
  let t1;
  if ($[0] !== label) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: label });
    $[0] = label;
    $[1] = t1;
  } else {
    t1 = $[1];
...
function TagChipInput(t0) {
  ...
  if ($[7] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Tags" });
    $[7] = t3;
  } else {
    t3 = $[7];
  }
...
const tradeSchema = objectType({
  ...
  action: enumType(["BOT", "SLD"]),
  quantity: numberType().positive("Quantity must be positive"),
  price: numberType().positive("Price must be positive"),
  account_id: stringType().min(1, "Account is required"),
  commission: numberType().min(0).default(0),
  realized_pnl: numberType().nullable().default(null),
...
function TradeDetailPanel(t0) {
  ...
  if (!trade) {
    let t52;
    if ($[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t52 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-fg-muted text-sm", children: "Select a trade to view details" });
      $[5] = t52;
    } else {
      t52 = $[5];
    }
  ...
  let t6;
  if ($[7] !== trade.exec_id) {
    t6 = /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-fg-muted font-mono", children: trade.exec_id });
    $[7] = trade.exec_id;
    $[8] = t6;
  } else {
    t6 = $[8];
  ...
  let t7;
  if ($[9] !== onClose) {
    t7 = /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-fg-muted hover:text-fg text-sm", "aria-label": "Close detail panel", children: "✕" });
    $[9] = onClose;
    $[10] = t7;
  } else {
    t7 = $[10];
  ...
  let t8;
  if ($[11] !== t6 || $[12] !== t7) {
    t8 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-bg-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      t6,
      t7
    ] }) });
    $[11] = t6;
  ...
  let t9;
  if ($[14] !== activeTab) {
    t9 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-bg-subtle", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveTab(tab.key), className: `px-4 py-2 text-sm transition-colors ${activeTab === tab.key ? "border-b-2 border-accent text-fg font-medium" : "text-fg-muted hover:text-fg"}`, children: tab.label }, tab.key)) });
    $[14] = activeTab;
    $[15] = t9;
  } else {
    t9 = $[15];
  ...
  let t10;
  if ($[16] !== activeTab || $[17] !== errors || $[18] !== handleSubmit || $[19] !== onClose || $[20] !== onDelete || $[21] !== onSubmit || $[22] !== register || $[23] !== trade) {
    t10 = activeTab === "info" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Instrument" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "data-testid": "trade-symbol-input", ...register("instrument"), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" }),
        errors.instrument && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400", children: errors.instrument.message })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Action" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { "data-testid": "trade-side-select", ...register("action"), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "BOT", children: "BOT" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "SLD", children: "SLD" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Qty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "data-testid": "trade-quantity-input", type: "number", ...register("quantity", {
            valueAsNumber: true
          }), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" }),
          errors.quantity && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400", children: errors.quantity.message })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Price" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { "data-testid": "trade-price-input", type: "number", step: "0.01", ...register("price", {
          valueAsNumber: true
        }), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" }),
        errors.price && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400", children: errors.price.message })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Account" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("account_id"), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" }),
        errors.account_id && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400", children: errors.account_id.message })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Commission" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.01", ...register("commission", {
            valueAsNumber: true
          }), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Realized P&L" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.01", ...register("realized_pnl", {
            valueAsNumber: true
          }), className: "w-full px-3 py-1.5 text-sm rounded-md bg-bg border border-bg-subtle text-fg" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs text-fg-muted mb-1", children: "Notes" }),
